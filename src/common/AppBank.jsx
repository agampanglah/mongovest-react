const options = [
    ...
    {
      value: 64,
      label: 'BANK RAKYAT INDONESIA (PERSERO)'
    },
    {
      value: 65,
    ...
    {
      value: 76,
      label: 'BANK TABUNGAN PENSIUNAN NASIONAL SYARIAH'
    },
    {
      value: 77,
    ...
    {
      value: 89,
      label: 'BPD JAWA BARAT DAN BANTEN'
    },
    {
      value: 90,
