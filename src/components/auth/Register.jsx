            ...
            <div>
                ...
                <Container >
                    <div>
                        ...
                        {/* <FormGroup row>
                                <Col sm='3' style={{ textAlign: 'left' }}><Label for='foto'>Profile Photo: </Label></Col>
                                <Col sm='5'> {imageUpload} </Col>
                            </FormGroup> */}

                            <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
                                <Label for="no_identitas" className="mr-sm-2" >identitas</Label>
                                <Input type= "identitas" name="no_identitas" placeholder="no identitas"  value={this.state.dataUser} onChange={this.RegistChange} />
                            </FormGroup>
